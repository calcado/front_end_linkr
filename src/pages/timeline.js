...
export default function Timeline() {
  ...
  function WhoLiked() {
    const requisition = axios.get(`${BASE_URL}/timeline/likes`);
  ...
  function editPost(){
    ...
    const requisition = axios.put(`${BASE_URL}/timeline/post/:id`);
  ...
  function deletePost(){
    const requisition = axios.delete(`${BASE_URL}/timeline/post/:id`)
    requisition.then((response )=> console.log(response));
    requisition.catch((response)=>response.map("Não foi possível deletar o post"))
  }
